...
* **İleri Düzey Entegrasyonlar ve Arayüzler:** REST API Checksum mantığı (LMS Bağlantıları), Webhooks, Greenlight v3 (OIDC/Keycloak) & PILOS (Akademik Arayüz) ve FreeSWITCH SIP Trunk (Telefon ile katılım) mimarisi.
