...
`bbb-html5` sunucu tarafı uygulaması, o an aktif olan toplantının tüm durumunu (kimler bağlı, tahtada ne çizilmiş, paylaşılan notlar vb.) MongoDB üzerinde depolar. Kalıcı veriden ziyade aktif oturumların durumunu tutmak için kullanılır (Epheremal state).
